...
#define FAL_PART_TABLE                                                               \
    {                                                                                    \
        ...
        {FAL_PART_MAGIC_WORD, "app_flash",     ON_CHIP_FLASH_DEV_NAME,   64*1024,  900*1024, 0}, \
        {FAL_PART_MAGIC_WORD, "tv",     ON_CHIP_FLASH_DEV_NAME,   964*1024,  60*1024, 0}, \
        {FAL_PART_MAGIC_WORD, "flashdb",            NOR_FLASH_DEV_NAME,         0, 1024*1024, 0}, \
        {FAL_PART_MAGIC_WORD, "filesystem",    NOR_FLASH_DEV_NAME,      1024*1024, 63*1024*1024, 0}, \
    }
